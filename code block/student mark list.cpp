...
float course[5][8],maxi[3],mini[3],max[5],min[5],smx,smn,mid,x[5],temp,final,total=0;
char cours[5];
int k;
for(int i=0;i<5;i++)
{
...
for(int k=0;k<5;k++)
{
cout<<name[k]<<setw(12)<<id[k]<<setw(12)<<dept[k]<<setw(12)<<course[k][3]<<setw(12);
cout<<course[k][4]<<setw(12)<<course[k][5]<<setw(12)<<course[k][6]<<setw(12);
cout<<course[k][7]<<setw(12)<<cours[k]<<endl;
}
for(int i=0;i<5;i++)
{
