...
char id[5][10];
 ...
 for(int i=0;i<5;i++)
 cin>>dept[i];
float course[5][8],maxi[3],mini[3],max[5],min[5],smx,smn,mid,maxx,in,temp,final,total=0;
char cours[5];
for(int i=0;i<5;i++)
{
...
course[i]=maxx;
course[in]=temp;*/
cout<<name[in]<<setw(12)<<id[in]<<setw(12)<<dept[in]<<setw(12)<<course[in][3]<<setw(12);
cout<<course[in][4]<<setw(12)<<course[in][5]<<setw(12)<<course[in][6]<<setw(12);
cout<<course[in][7]<<setw(12)<<cours[in]<<endl;
}
for(int i=0;i<5;i++)
{
