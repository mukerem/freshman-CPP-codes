...
int main()
{
int date,month,year,math,rapi,Date,Month,Year,k,m,ethio,choise;
cout<<"WHAT YOU WANT\n";
cout<<"ENTER 1:TO convert Ethiopian calender to Goregorian calender\n";
cout<<"ENTER 2:TO convert Goregorian calender to Ethiopian calender\n";
cin>>choise;
